...
public class ConsoleOutput {
    ...
    public static void printCourse(Course course) {
        ...
        System.out.println(printLine("6. Requirements: " + course.getCourseDescription(), 1));
        for (CourseCondition requirements : course.getRequirementList()) {
            System.out.println(printLine("- " + requirements.getTypeName() + ":", 2));
    ...
    public static void printChoiceMenu(String label, String[] text) {
        ...
        for (int i = 0; i < text.length; i++) {
            System.out.println(printLine((i+1) + ". " + text[i], 0, WIDTH, INDENT_SPACE));
        }
